...
use crate::flamegraph::{build_callstack_urls, collect_and_generate_flamegraph, load_collector_config, get_config_path};
...
async fn collect_global_flamegraph() -> Result<String, String> {
    ...
    tracing::info!("Collecting global flamegraph from {} URLs across {} nodes", 
                   all_urls.len(), nodes.len());
